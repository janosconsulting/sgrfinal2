    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/plugins/dataPickerStyles").Include(
                      "~/Scripts/assets/lib/datetime/datepicker.min.css"));

            // dataPicker 
            bundles.Add(new ScriptBundle("~/plugins/dataPicker").Include(
                      "~/Scripts/assets/lib/datetime/datepicker.min.js"));
            ...
            bundles.Add(new StyleBundle("~/plugins/sweetAlertStyles").Include(
                      "~/Scripts/plugins/sweetalert2/sweetalert2.min.css"));

            // Sweet alert
            bundles.Add(new ScriptBundle("~/plugins/sweetAlert").Include(
                      "~/Scripts/assets/lib/sweetalert2/sweetalert2.min.js"));
