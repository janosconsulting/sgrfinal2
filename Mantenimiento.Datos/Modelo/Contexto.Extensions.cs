...
namespace Mantenimiento.Datos.Modelo
{
    ...
    public static class SelfTrackingEntitiesContextExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="TEntidad">Expected type of the ObjectSet</typeparam>
        ...
        public static void ApplyChanges<TEntidad>(this ObjectSet<TEntidad> objectSet, TEntidad entity) where TEntidad : class, IObjectWithChangeTracker
        {
            if (objectSet == null)
            {
            ...
            objectSet.Context.ApplyChanges<TEntidad>(objectSet.EntitySet.EntityContainer.Name + "." + objectSet.EntitySet.Name, entity);
        }
    
        /// <summary>
        /// ApplyChanges takes the changes in a connected set of entities and applies them to an ObjectContext.
        /// </summary>
        /// <typeparam name="TEntidad">Expected type of the EntitySet</typeparam>
        ...
        /// <param name="entity">The entity serving as the entry point of the object graph that contains changes.</param>
        public static void ApplyChanges<TEntidad>(this ObjectContext context, string entitySetName, TEntidad entity) where TEntidad : IObjectWithChangeTracker
        {
            if (context == null)
            {
