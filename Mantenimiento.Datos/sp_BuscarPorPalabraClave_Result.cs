...
namespace Mantenimiento.Datos.Entidades
{
    ...
    public partial class sp_BuscarPorPalabraClave_Result : INotifyComplexPropertyChanging, INotifyPropertyChanged
    {
        ...
        public static void RecordComplexOriginalValues(String parentPropertyName, sp_BuscarPorPalabraClave_Result complexObject, ObjectChangeTracker changeTracker)
        {
