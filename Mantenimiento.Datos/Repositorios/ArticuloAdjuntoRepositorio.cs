...
{
    public class ArticuloAdjuntoRepositorio : Repositorio<ArticuloAdjunto>, IArticuloAdjuntoRepositorio
    {
        public ArticuloAdjuntoRepositorio(IContexto contexto, IOcurrencia ocurrencia)
