...
{
    public class ArticuloReferenciaRepositorio: Repositorio<ArticuloReferencia>, IArticuloReferenciaRepositorio
    {
        public ArticuloReferenciaRepositorio(IContexto contexto, IOcurrencia ocurrencia)
