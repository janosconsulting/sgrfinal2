...
namespace Mantenimiento.Datos.Entidades
{
    ...
    public partial class ArticuloAdjunto: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Propiedades primitivas
    
        [DataMember]
        public int idArticuloAdjunto
        {
            get { return _idArticuloAdjunto; }
            set
            {
                if (_idArticuloAdjunto != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("La propiedad 'idArticuloAdjunto' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.");
                    }
                    _idArticuloAdjunto = value;
                    OnPropertyChanged("idArticuloAdjunto");
                }
            }
        }
        private int _idArticuloAdjunto;
        ...
        private void FixupArticulo(Articulo previousValue)
        {
            ...
            if (previousValue != null && previousValue.ArticuloAdjunto.Contains(this))
            {
                previousValue.ArticuloAdjunto.Remove(this);
            }
    
            if (Articulo != null)
            {
                if (!Articulo.ArticuloAdjunto.Contains(this))
                {
                    Articulo.ArticuloAdjunto.Add(this);
                }
